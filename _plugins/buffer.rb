...
module Jekyll
  ...
  class BufferCollectionGenerator < Generator
    ...
    def generate(site)
      ...
      twitter = ENV['BUFFER_TWITTER_PROFILE'] || site.config['buffer_twitter_profile'] or false
      facebook = ENV['BUFFER_FACEBOOK_PROFILE'] || site.config['buffer_facebook_profile'] or false
      linkedin = ENV['BUFFER_LINKEDIN_PROFILE'] || site.config['buffer_linkedin_profile'] or false
      access_token = ENV['BUFFER_ACCESS_TOKEN'] || site.config['buffer_access_token'] or false
